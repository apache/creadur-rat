...
public class GeneratedLicenseNotRequired extends BaseLicense {
    ...
    public GeneratedLicenseNotRequired(final Pattern[] linePatterns) {
        super(new SimpleLicenseFamily(MetaData.RAT_LICENSE_FAMILY_CATEGORY_VALUE_GEN, "Generated Code"), "");
...
//    public void reportOnLicense(Document subject) {
