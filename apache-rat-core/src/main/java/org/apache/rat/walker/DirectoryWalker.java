...
public class DirectoryWalker extends Walker implements IReportable {
     ...
     *
     * @param file not null
     * @param filter filters input files (optional), or null when no filtering
     * should be performed
     */
    ...
    /**
     * Run a report over all files and directories in this DirectoryWalker, ignoring
     * any files/directories set to be ignored.
     *
    ...
    /**
     * Process all directories in a set of file objects, ignoring any directories
     * set to be ignored.
     *
     * @param report the report to use in processing
