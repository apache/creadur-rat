...
public class GeneratedLicenseTest extends AbstractLicenseTest {
    private static final String id = "GEN";
    private static final String name = "Generated Files";
    private static final String notes = "Files that are automatically generated.";
