...
public class OASISLicenseTest extends AbstractMatcherTest {

    private static String category = "OASIS";
    private static String name = "OASIS Open License";
    private static String[][] targets = {
            { "fulltext", "No modifications allowed", "This document and translations of it may be copied and furnished to others and derivative works that comment on or otherwise explain it or assist in its implementation may be prepared copied published and distributed"},
            {"copyright", "No modifications allowed", ".*Copyright\\s.*OASIS Open.*"}
    };
