...
public class GitIgnoreBuilderTest extends AbstractIgnoreBuilderTest {
    ...
    public void test_global_gitignore() {
        ...
        assertThat(matcher.toString()).isEqualTo("matcherSet(or('included global gitignore', 'included dir1/.gitignore', 'included .gitignore'), or('excluded global gitignore', 'excluded dir1/.gitignore', **/.gitignore, 'excluded .gitignore'))");
