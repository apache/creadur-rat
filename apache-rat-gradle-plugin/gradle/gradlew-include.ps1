...
# This fixes an issue that Get-FileHash works fine "out of the box" on older systems, but fails on newer ones.
# More info via https://github.com/actions/runner-images/issues/225
