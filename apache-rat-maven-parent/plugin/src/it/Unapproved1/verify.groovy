...
configFile = new File(basedir, "target/RAT/configuration.xml")
statsFile = new File(basedir, "target/RAT/claimStatistics.xml")

ValidatorData. data = new ValidatorData(Reporter.Output.builder()
